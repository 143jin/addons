...
### 난방 ###
optional_info = {'modes': ['off', 'heat'],'preset_modes': ['외출', '온수'], 'temp_step': 1.0, 'precision': 1.0, 'min_temp': 5.0, 'max_temp': 45.0, 'send_if_off': 'false'}
...
for message_flag in ['81', 'C3', 'C4', 'C5', 'C6', 'C7']:
    ...
    거실난방.register_status(  message_flag = message_flag, attr_name = '외출', topic_class = '외출_state_topic', regex = r'00[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[4] == '1' else 'OFF')
    안방난방.register_status(  message_flag = message_flag, attr_name = '외출', topic_class = 'optional_info = {'modes': ['off', 'heat'],'preset_modes': ['외출', '온수'],_state_topic', regex = r'00[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[3] == '1' else 'OFF')
    확장난방.register_status(  message_flag = message_flag, attr_name = '외출', topic_class = 'optional_info = {'modes': ['off', 'heat'],'preset_modes': ['외출', '온수'],_state_topic', regex = r'00[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[2] == '1' else 'OFF')
    제인이방난방.register_status(  message_flag = message_flag, attr_name = '외출', topic_class = 'optional_info = {'modes': ['off', 'heat'],'preset_modes': ['외출', '온수'],_state_topic', regex = r'00[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[1] == '1' else 'OFF')
    팬트리난방.register_status(message_flag = message_flag, attr_name = '외출', topic_class = 'optional_info = {'modes': ['off', 'heat'],'preset_modes': ['외출', '온수'],_state_topic', regex = r'00[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[0] == '1' else 'OFF')
    
    거실난방.register_status(  message_flag = message_flag, attr_name = '온수', topic_class = '온수_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{4}([\da-fA-F]{2})[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[4] == '1' else 'OFF')
    안방난방.register_status(  message_flag = message_flag, attr_name = '온수', topic_class = '온수_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{4}([\da-fA-F]{2})[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[3] == '1' else 'OFF')
    확장난방.register_status(  message_flag = message_flag, attr_name = '온수', topic_class = '온수_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{4}([\da-fA-F]{2})[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[2] == '1' else 'OFF')
    제인이방난방.register_status(  message_flag = message_flag, attr_name = '온수', topic_class = '온수_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{4}([\da-fA-F]{2})[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[1] == '1' else 'OFF')
    팬트리난방.register_status(message_flag = message_flag, attr_name = '온수', topic_class = '온수_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{4}([\da-fA-F]{2})[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: 'ON' if format(int(v, 16), '05b')[0] == '1' else 'OFF')
...
거실난방.register_command(message_flag = '45', attr_name = '외출', topic_class = '외출_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
거실난방.register_command(message_flag = '47', attr_name = '온수', topic_class = '온수_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
안방난방.register_command(message_flag = '45', attr_name = '외출', topic_class = '외출_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
안방난방.register_command(message_flag = '47', attr_name = '온수', topic_class = '온수_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
확장난방.register_command(message_flag = '45', attr_name = '외출', topic_class = '외출_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
확장난방.register_command(message_flag = '47', attr_name = '온수', topic_class = '온수_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
제인이방난방.register_command(message_flag = '45', attr_name = '외출', topic_class = '외출_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
제인이방난방.register_command(message_flag = '47', attr_name = '온수', topic_class = '온수_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
팬트리난방.register_command(message_flag = '45', attr_name = '외출', topic_class = '외출_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
팬트리난방.register_command(message_flag = '47', attr_name = '온수', topic_class = '온수_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
