...
for message_flag in ['81', 'C3', 'C4', 'C5', 'C6', 'C7']:
    ...
    거실난방.register_status(  message_flag = message_flag, attr_name = 'fan_only', topic_class = 'mode_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: '온수' if format(int(v, 16), '05b')[4] == '1' else 'OFF')
    안방난방.register_status(  message_flag = message_flag, attr_name = 'fan_only', topic_class = 'mode_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: '온수' if format(int(v, 16), '05b')[3] == '1' else 'OFF')
    확장난방.register_status(  message_flag = message_flag, attr_name = 'fan_only', topic_class = 'mode_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: '온수' if format(int(v, 16), '05b')[2] == '1' else 'OFF')
    제인이방난방.register_status(  message_flag = message_flag, attr_name = 'fan_only', topic_class = 'mode_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: '온수' if format(int(v, 16), '05b')[1] == '1' else 'OFF')
    팬트리난방.register_status(message_flag = message_flag, attr_name = 'fan_only', topic_class = 'mode_state_topic', regex = r'00[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}([\da-fA-F]{2})[\da-fA-F]{4}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}[\da-fA-F]{2}', process_func = lambda v: '온수' if format(int(v, 16), '05b')[0] == '1' else 'OFF')
...
거실난방.register_command(message_flag = '47', attr_name = 'fan_only', topic_class = 'away_mode_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
안방난방.register_command(message_flag = '47', attr_name = 'fan_only', topic_class = 'away_mode_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
확장난방.register_command(message_flag = '47', attr_name = 'fan_only', topic_class = 'away_mode_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
제인이방난방.register_command(message_flag = '47', attr_name = 'fan_only', topic_class = 'away_mode_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
...
팬트리난방.register_command(message_flag = '47', attr_name = 'fan_only', topic_class = 'away_mode_command_topic', process_func = lambda v: '01' if v =='ON' else '00')
